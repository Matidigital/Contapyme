...
-- Ejecutar en la base de datos contapymepuq
...
-- Trigger para actualizar updated_at en payroll_books
...
CREATE TRIGGER trigger_update_payroll_books_updated_at
...
COMMENT ON COLUMN payroll_book_details.total_haberes IS 'Total de haberes imponibles y no imponibles';
COMMENT ON COLUMN payroll_book_details.total_descuentos IS 'Total de descuentos legales y voluntarios';