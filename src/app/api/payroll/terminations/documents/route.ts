...
<body>
    ...
    <div class="header">
        ...
        <div class="company-details">
            ...
            ${company.address || 'Punta Arenas, Chile'}
        </div>
    </div>
    ...
    <div class="signatures">
        <div class="signature-section">
            <div class="signature-line">
                EMPLEADOR<br>
                ${company.legal_representative_name || '[NOMBRE REPRESENTANTE LEGAL]'}<br>
                RUT: ${company.legal_representative_rut || '[RUT REPRESENTANTE]'}
            </div>
        </div>
