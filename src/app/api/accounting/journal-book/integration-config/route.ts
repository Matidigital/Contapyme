...
export async function GET(request: NextRequest) {
  try {
    ...
    // Si no existe configuración, devolver la configuración por defecto
    const config = existingConfig ? existingConfig.config : DEFAULT_INTEGRATION_CONFIG;
