          ...
          <div className="bg-green-50 p-3 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              {result.legal_gratification_art50 > 0 && (
                <div className="flex justify-between items-center bg-purple-50 -mx-1 px-1 py-1 rounded">
                  <div className="flex items-center gap-1">
                    <svg className="w-3 h-3 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <span className="text-sm text-purple-700 font-medium">Gratificación Art. 50</span>
                  </div>
                  <span className="font-semibold text-purple-700">{formatCurrency(result.legal_gratification_art50)}</span>
                </div>
              )}
            </div>
